...
define("libs/require/almond", function(){});
...
define('text!templates/main/main_view.html',[],function () { return '<%= message %>';});

define('views/main/main_view',[    
    'jquery',
	  'underscore',
	  'backbone',
...
define('routers/main_router',['jquery',
				'underscore',
				'backbone',
				"../models/asset",
...
define('no_conflict',['jquery'], function($){
